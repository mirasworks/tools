...
public class ConfigurationManager {
	...
	/**
	 * check if the configuration folder had been set in system properties if it
	 * had been set it verify if the folder exists and application has
	...
	public boolean initConfiguration() {
		...
		if (systemHasPropertie(pluginPathPropertieName)) {
			...
			System.out.println("plugin path had not been specified with  -Dargs exemple : -D" + pluginPathPropertieName
					+ "=c:/_dev/_src/hello");
	...
	/**
	 * return a configuration, config are available from configuration files or
	...
	public String getKey(String key, String defaultValue) {
		...
		if (value == null || value.isEmpty()) {
			l.warn("{} not configured. Default value set to {}. It could be configured by system properties or by configuration file here {}",
					key, defaultValue, getPropertieFilePath());
			return defaultValue;
		} else {
			return value;
		}
